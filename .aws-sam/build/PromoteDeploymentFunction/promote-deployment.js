...
var promote_deployment_exports = {};
__export(promote_deployment_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(promote_deployment_exports);
...
function parsePromoteRequest(body) {
  if (!body) {
    return null;
  }
...
async function handler(event) {
  ...
  try {
    ...
    const config = await getConfig2(mappingId, source.sourceNumber);
    if (!config) {
      return errorResponse(
...
//# sourceMappingURL=promote-deployment.js.map
