...
// src/lambda/deployment/get-current-deployments.ts
var get_current_deployments_exports = {};
__export(get_current_deployments_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_current_deployments_exports);
...
async function getCurrent(mappingId, environment) {
...
async function getCurrentAll(mappingId) {
...
//# sourceMappingURL=get-current-deployments.js.map
