...
| [ui-application.md](./ui-application.md)       | UI application architecture — adapter pattern, state management (AsyncState), routing, component organization, technology stack, and Phase 0 constraints.                                                 | 2026-05-01   |
