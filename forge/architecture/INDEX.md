...
**Recent update note (2026-05-11):** `ui-application.md` was updated for FS-043 Array Builder redesign architecture (`ArrayBuilder` two-layer model, `useArrayBuilderState` contract, array state/generator/decomposer/validation modules, mode-switch + nested + cross-array lookup + array preview model).
