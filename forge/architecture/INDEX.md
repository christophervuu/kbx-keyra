...
| [ui-application.md](./ui-application.md)       | UI application architecture — adapter pattern, state management (AsyncState), engine integration boundary/hooks, Mapping Editor three-column target-driven layout (FS-020), Schema Detail page architecture (FS-015), routing, component organization, technology stack, and Phase 0 constraints. | 2026-05-03   |
